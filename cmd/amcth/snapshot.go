...
import (
	...
	"github.com/prashantprabhakar/go-amcchain/core/state/snapshot"
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
amcth snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
amcth snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
amcth snapshot check-dangling-storage <state-root> traverses the snap storage
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
amcth snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
amcth snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
amcth snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'amcth dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'amcth dump', but uses the snapshots
