...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage AmcChain presale wallets",
		ArgsUsage: "",
		Description: `
    amcth wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import AmcChain presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	amcth wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    amcth account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    amcth account import [options] <keyfile>
