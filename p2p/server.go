...
// Package p2p implements the AmcChain p2p network protocols.
package p2p
...
import (
	...
	"github.com/prashantprabhakar/go-amcchain/p2p/discover"
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // AmcChain Node Record
