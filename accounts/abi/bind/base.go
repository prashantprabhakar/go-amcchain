...
// valid AmcChain transaction.
type TransactOpts struct {
	From   common.Address // AmcChain account to send the transaction from
...
// AmcChain network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the AmcChain blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct AmcChain methods
...
// DeployContract deploys a contract onto the AmcChain blockchain and binds the
