...
import (
	...
	"github.com/prashantprabhakar/go-amcchain/accounts/usbwallet/trezor"
...
// or whether the AmcChain app was not started on it.
...
// AmcChain address located on that path.
