...
coverpkg="github.com/prashantprabhakar/go-amcchain/..."
...
repo=$GOPATH/src/github.com/prashantprabhakar/go-amcchain
compile_fuzzer github.com/prashantprabhakar/go-amcchain/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/prashantprabhakar/go-amcchain/common/bitutil \
...
compile_fuzzer github.com/prashantprabhakar/go-amcchain/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/prashantprabhakar/go-amcchain/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/prashantprabhakar/go-amcchain/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/prashantprabhakar/go-amcchain/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/prashantprabhakar/go-amcchain/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/prashantprabhakar/go-amcchain/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/prashantprabhakar/go-amcchain/eth/protocols/snap \
...
compile_fuzzer github.com/prashantprabhakar/go-amcchain/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/prashantprabhakar/go-amcchain/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/prashantprabhakar/go-amcchain/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/prashantprabhakar/go-amcchain/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
