...
// timestampThreshold is the AmcChain mainnet genesis timestamp. It is used to
...
// NewID calculates the AmcChain fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the AmcChain fork ID from an existing chain instance.
