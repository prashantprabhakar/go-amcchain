...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte AmcChain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an AmcChain account at a particular block.
    type Account {
    ...
    # Transaction is an AmcChain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an AmcChain account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an AmcChain account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an AmcChain block by number or by hash. If neither is
