...
func makeSealer(genesis *core.Genesis) (*node.Node, *eth.AmcChain, error) {
	// Define the basic configurations for the AmcChain node
	...
	// Start the node and configure a full AmcChain node on it
