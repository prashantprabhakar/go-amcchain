...
# 1. install amcth for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for amcth
# 5. create amcth, attach and uninstall start menu entries
...
!define GROUPNAME "AmcChain"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the AmcChain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since amcth is installed global
